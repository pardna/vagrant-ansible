	...
	if ( count( $content ) > 1 ) {
		if ( $more ) {
			...
			if ( ! empty( $more_link_text ) )
				 ...
				 */
				$output .= apply_filters( 'the_content_more_link', ' <a href="' . get_permalink() . "#more-{$post->ID}\" class=\"more-link btn waves-effect waves-light\">$more_link_text</a>", $more_link_text );
